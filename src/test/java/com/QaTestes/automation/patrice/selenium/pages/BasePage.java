...
public abstract class BasePage {
	...
	public void type(String input, By loctor) {
		this.driver.findElement(loctor).sendKeys(input);
	}
	...
	public String getTextByAttribute(By locater, String attributeName) {
		return this.driver.findElement(locater).getAttribute(attributeName);
	}
